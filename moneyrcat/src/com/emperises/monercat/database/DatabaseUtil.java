...
public class DatabaseUtil {
	...
	public static MyInfo getMyInfo(SQLiteDatabase db) throws InstantiationException, IllegalAccessException{
		List<Object> objs = queryDatabaseForClass(MyInfo.class, db , null, null);
		if(objs != null){
			return (MyInfo) objs.get(0);
		}
		return null;
	 ...
	 * @throws IllegalArgumentException
	 */
	public static void saveMyInfo(DomainObject myInfoObj, SQLiteDatabase db) throws IllegalArgumentException, IllegalAccessException{
